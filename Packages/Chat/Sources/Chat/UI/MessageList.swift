...
/// Stable turn containers keep response updates in place. Explicit sends focus the user turn;
/// a user-requested bottom seek may keep refining until rendered arrival.
