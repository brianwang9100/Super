...
- **Formatting** (`Formatting/`): pure, view-free text rendering — `BibleCitationFormatter` compresses contiguous verse runs to ranges (`"4-6, 9"`); `BibleVerseAnnouncement` builds the VoiceOver label a verse span speaks.
