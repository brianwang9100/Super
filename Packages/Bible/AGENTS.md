...
- Verse words coalesce into one VoiceOver element per verse: the first word labels the verse, remaining words are accessibility-hidden. Sheet motion uses `BibleSheetMotion`.
