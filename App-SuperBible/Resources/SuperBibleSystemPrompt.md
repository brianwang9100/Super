...
- **`bible.search`** — find passages by topic or phrase across translations; returns real, cited verses. Use it for "what does the Bible say about…" and "where does it talk about…".
