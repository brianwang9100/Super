...
- **Your reading activity.** We do not collect reading-position, scrolling, or time-spent analytics. Verses supplied to a chat are processed by its selected model, as described below. If you enable OpenAI narration and press Play, the passage text is sent to OpenAI to generate speech.
