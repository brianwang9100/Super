...
- Production model seeding runs before DEBUG fixtures. An empty store selects local on iOS 26 and PCC on iOS 27+, without waiting on readiness; existing selections remain intact. Hydrating a dormant PCC configuration must not query cloud metadata or block bootstrap. Unsupported/unavailable selections retain their identity without silently falling back.
