...
The centered scroll-to-bottom control adds two Chat screen captures for light/dark glass contrast and copy-confirmation separation, bringing the total from 623 to 625. The current package inventory is Bible 276, Chat 246, Core 20, and Todo 42, plus 41 native previews. The four explicit Bible variant IDs account for Bible’s filename count changing from 272 to 276.
