...
The current package inventory is Bible 278, Chat 246, Core 20, and Todo 42, plus 41 native previews. The navigation-history state gallery and narrow accessibility case add two Bible captures to the restored 623-image inventory. The centered scroll-to-bottom control adds two Chat screen captures for light/dark glass contrast and copy-confirmation separation, bringing the combined total to 627. The four explicit Bible variant IDs account for Bible’s filename count changing from 272 to 276.
