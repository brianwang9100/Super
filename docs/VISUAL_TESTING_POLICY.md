...
The current package inventory is Bible 278, Chat 244, Core 20, and Todo 42, plus 41 native previews. The navigation-history state gallery and narrow accessibility case add two Bible captures. The four explicit Bible variant IDs account for Bible’s filename count changing from 272 to 276.
