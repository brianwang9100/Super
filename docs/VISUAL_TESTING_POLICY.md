...
The iPad layout update adds eight captures (591 → 599 in the tracked inventories): wide Bible navigation/reading, a narrow reader at 120%, wide Bookmarks and Chats, three wide Chat overlay states over a contrasting backdrop, and a short acknowledgment sheet at 120%. Existing phone captures remain unchanged. The earlier prose count of 590 omitted an already tracked Chat capture.
