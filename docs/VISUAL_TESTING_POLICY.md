...
The iPad layout update adds eight captures (593 → 601 in the tracked inventories): wide Bible navigation/reading, a narrow reader at 120%, wide Bookmarks and Chats, three wide Chat overlay states over a contrasting backdrop, and a short acknowledgment sheet at 120%. Existing phone captures remain unchanged. The earlier prose count of 590 omitted an already tracked Chat capture; PR #371 then added two navigation accessibility captures, establishing the 593-image base for this update.

The iPad reading modes add eight captures (601 → 609): a continuing Book verse in light/dark, a compact chapter opening, aligned comparison rows with missing verses and poetry, stacked comparison at 120%, regular/narrow inline-control galleries, and a narrow navigation gallery for the three cycling mode icons. Existing phone and legacy iPad fixtures remain enabled.
