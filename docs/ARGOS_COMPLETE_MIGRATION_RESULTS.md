...
| Chat | 246 | 243 | Two identical automatic-title fixtures and one redundant compaction fixture consolidated |
| Core | 20 | 20 | Preserved |
| Todo | 42 | 42 | Preserved |
| Package total | 580 | 581 | All retained scenarios accounted for |

The existing 41 native captures remain, giving **622 images in one complete Argos build**. The working tree contains zero package UI baseline PNGs. Source fixtures, inventories, and reviewed dependency locks stay tracked; generated images are ignored. This normal commit does not rewrite Git history or reclaim historical objects.
...
The first complete local set passed exact inventory, dimensions, PNG decoding, and five-shard aggregation checks on Xcode 26.4.1 / 17E202, iOS 26.4.1 / 23E254a, and the registered iPhone 17 simulator.
...
## Verification and failure controls
