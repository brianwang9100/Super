...
Status: implementation and normal CI complete; compatibility/release gates remain open, 2026-09-06, branch `codex/xcode-27-pcc`. The phase sections below remain the acceptance checklist; unchecked gates are not claims of completion.
