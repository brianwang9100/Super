...
- [ ] Pass fresh normal CI against the complete references.
...
- Final-source iOS 26 smoke [34066714230](https://github.com/brianwang9100/Super/actions/runs/34066714230), source `664a861b`, is pending to verify the last provider-construction change as well. Subsequent baseline/documentation-only changes do not affect its executable source.
